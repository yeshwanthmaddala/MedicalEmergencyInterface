...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["FINDING HOSPITALS NEAR YOU","GETTING DOCTOR STATUS","FINDING BEST ROUTE","3 HOSPITALS FOUND","SEARCHING FOR DOCTORS","FINDING BEST ROUTE"]);
  ...
  function animateLoading() {
    ...
    upward_moving_group.currentY -= 3.35 * easeInOut(now);
